...
export const ADD_EVENT = gql`
    mutation AddEvent($ambitionId: ID!, $createdAt: String!, $dataInput: Float!, $notes: String) {
      addEvent(ambitionId: $ambitionId, createdAt: $createdAt dataInput: $dataInput, notes: $notes) {
        daysCount
        events {
          createdAt
          dataInput
